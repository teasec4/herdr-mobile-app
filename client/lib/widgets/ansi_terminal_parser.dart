...
///
/// Renders the way a terminal would: `\r` rewinds to the start of the current
/// line and overwrites its cells (so progress bars / spinners don't turn into
/// mush), SGR sequences become styled spans, and every other escape is
/// stripped safely.
