...
/// Legacy monolithic WebSocket client — kept only as a rollback path while the
/// layered refactor lands (docs/09-refactoring-plan.md, Phase 3).
///
/// Do not add features here. New code goes through
/// `RelayClientImpl` (Transport + Protocol + ConnectionManager).
@Deprecated('Use RelayClientImpl — see docs/09-refactoring-plan.md')
