...
Статус: **черновик (утверждён для планирования, код не менялся)**
Дата: 2026-08-30
...
#### A1. Единый источник `agent_status_changed` = сокет; убрать хук и дубль-роут
...
#### A2. Расширить `AgentStatusChangedEvent` полями
...
#### A3. Убрать инертный revision-guard
...
#### B3. Прерываемый reconnect-цикл сокета
